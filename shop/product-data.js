...
const productsData = {
    ...
    powerModuleImplant: {
        name: "Power Module",
        shortDescription: "Assembled and enclosed COSMIIC System Power Module. <strong>For research use only.</strong>",
        price: "$15,000",
        priceClass: "text-muted",
        imageType: "img",
        image: "./product-img/AI-PM.png",
        comingSoon: true,
    ...
    bp2ModuleImplant: {
        name: "BP2 Module",
        shortDescription: "Assembled and enclosed COSMIIC System BP2 Module. <strong>For research use only.</strong>",
        price: "$11,600",
        imageType: "icon",
        image: "users",
        comingSoon: true,
    ...
    imStimElectrode: {
        ...
        shortDescription: "An implanted lead connected to the PG4 Module placed in a muscle that delivers electrical pulses to activate the nerves controlling that muscle. <strong>For research use only.</strong>",
        price: "$1,455",
        imageType: "icon",
        image: "zap",
        comingSoon: false,
    ...
    imRecordingElectrode: {
        ...
        shortDescription: "An implanted lead connected to the BP2 Module placed in a muscle that records MES signals. <strong>For research use only.</strong>",
        price: "$1,499",
        imageType: "icon",
        image: "users",
        comingSoon: false,
    ...
    epiRecordingElectrode: {
        ...
        shortDescription: "An implanted lead connected to the BP2 Module placed on a muscle that records MES signals. <strong>For research use only.</strong>",
        price: "$2,199",
        imageType: "img",
        image: "product-img/AI-EPI.png",
        comingSoon: false,
    ...
    networkCable: {
        name: "Network Cable",
        shortDescription: "An implanted lead that connects all implanted COSMIIC modules. <strong>For research use only.</strong>",
        price: "$2,350",
        imageType: "img",
        image: "product-img/AI-NC.png",
        comingSoon: false,
    ...
    consulting: {
        ...
        shortDescription: "Expert guidance to accelerate your neural interface development and navigate the technical and regulatory landscape with confidence.",
        ...
        features: [
            ...
            "Study design and experimental protocol development",
            "Regulatory strategy and FDA/CE compliance planning",
            "Clinical trial design and execution",
            "Quality management system (QMS) implementation",
            "Risk management and ISO 14971 compliance",
        ...
        additionalInfo: "We offer flexible engagement models including hourly consulting, fixed-price projects, and retainer arrangements. Initial consultations are available to discuss your needs and develop a custom engagement plan.",
        warning: null
    }
};